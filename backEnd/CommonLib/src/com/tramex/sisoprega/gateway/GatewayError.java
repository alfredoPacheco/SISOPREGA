...
public class GatewayError {
  ...
  public GatewayError(String exceptionId, String exceptionDescription, String origin) {
  ...
  public String toString() {
    return "error:{exceptionId:" + exceptionId + ";exceptionDescription:" + exceptionDescription + ";origin:" + origin + ";}";
  }
}
