...
/**
 * Session Bean implementation class InspectionForecastBean
 */
@Stateless
...
public class InspectionForecastBean extends BaseBean implements Cruddable {
  ...
  public ReadResponse Read(ReadRequest request) {
    ...
    try {
      String sForecastDate = request.getFilter().getFieldValue("forecastDate");
      String queryName = "";
      Map<String, Object> parameters = new HashMap<String, Object>();

      if (sForecastDate != null) {
        parameters.put("forecastDate", sForecastDate);
        queryName = "INSPECTIONFORECAST_BY_DATE";
      } else {
