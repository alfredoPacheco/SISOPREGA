...
rawPath: c,
path: g
}), enyo.script(g); else return h(g, f), !0;
}, h = function(a, b) {
...
return delete a.name, a.hasOwnProperty("constructor") && (a._constructor = a.constructor, delete a.constructor), enyo.setPrototype(f, e ? enyo.delegate(e) : {}), enyo.mixin(f.prototype, a), f.prototype.kindName = b, f.prototype.base = d, f.prototype.ctor = f, enyo.forEach(enyo.kind.features, function(b) {
b(f, a);
...
return this._componentNameMap[b] = Number(c) + 1, a.name = b + (c > 1 ? String(c) : "");
},
...
if (c) {
var d = b;
return c._dispatcher || (d = [ this ], b && Array.prototype.push.apply(d, b)), c.apply(this.owner, d || []);
}
},
...
enyo.g11n = function() {}, enyo.g11n._init = function a() {
...
}, enyo.g11n.setLocale = function(a) {
...
enyo.g11n.Fmts = function a(a) {
var b;
typeof a == "undefined" || !a.locale ? this.locale = enyo.g11n.formatLocale() : typeof a.locale == "string" ? this.locale = new enyo.g11n.Locale(a.locale) : this.locale = a.locale, this.dateTimeFormatHash = enyo.g11n.Utils.getJsonFile({
...
return typeof this.twelveHourFormat == "undefined" && (enyo.g11n.getPlatform() === "device" ? this.twelveHourFormat = PalmSystem.timeFormat === "HH12" : this.twelveHourFormat = this.dateTimeFormatHash.is12HourDefault), this.twelveHourFormat;
...
return this.dateTimeFormatHash ? this.dateTimeFormatHash.dateFieldOrder : (console.warn("Failed to load date time format hash"), "mdy");
}, enyo.g11n.Fmts.prototype.getTimeFieldOrder = function() {
return this.dateTimeFormatHash ? this.dateTimeFormatHash.timeFieldOrder : (console.warn("Failed to load date time format hash"), "hma");
...
return this.dateTimeHash ? this.dateTimeHash.am : (console.error("Failed to load dateTimeHash."), "AM");
}, enyo.g11n.Fmts.prototype.getPmCaption = function() {
return this.dateTimeHash ? this.dateTimeHash.pm : (console.error("Failed to load dateTimeHash."), "PM");
...
enyo.g11n.Locale = function a(a) {
var b = a ? a.split(/_/) : [];
return this.locale = a, this.language = b[0] || undefined, this.region = b[1] ? b[1].toLowerCase() : undefined, this.variant = b[2] ? b[2].toLowerCase() : undefined, this;
...
var a = this.language || "";
return this.region && (a += "_" + this.region.toUpperCase()), this.variant && (a += "_" + this.variant.toUpperCase()), a;
}, enyo.g11n.Locale.prototype.isMatch = function(a) {
return a.language && a.region ? (!this.language || this.language === a.language) && (!this.region || this.region === a.region) : a.language ? !this.language || this.language === a.language : !this.region || this.region === a.region;
...
enyo.g11n.Utils = enyo.g11n.Utils || function() {}, enyo.g11n.Utils._fileCache = {}, enyo.g11n.Utils._setRoot = function a(a) {
...
}, enyo.g11n.Utils._getEnyoRoot = function c(a) {
var b, c = "";
...
return c + d;
}, enyo.g11n.Utils._loadFile = function d(a) {
...
return b;
}, enyo.g11n.Utils.getNonLocaleFile = function(a) {
var b, c, d;
...
return b;
}, enyo.g11n.Utils.getJsonFile = function f(a) {
...
return b;
}, enyo.g11n.Utils._merge = function(a) {
var b, c, d = {};
for (b = 0, c = a.length; b < c; b++) d = enyo.mixin(d, a[b]);
return d;
}, enyo.g11n.Utils.releaseAllJsonFiles = function h(a, b) {
var c = new Date, d = [], e, f, g, h;
a = a || 6e4;
if (this.oldestStamp !== undefined && this.oldestStamp.getTime() + a < c.getTime()) {
e = c;
for (f in enyo.g11n.Utils._fileCache) f && enyo.g11n.Utils._fileCache[f] && (h = enyo.g11n.Utils._fileCache[f], !h.locale || b || !enyo.g11n.currentLocale().isMatch(h.locale) && !enyo.g11n.formatLocale().isMatch(h.locale) && !enyo.g11n.phoneLocale().isMatch(h.locale) ? h.timestamp.getTime() + a < c.getTime() ? d.push(h.path) : h.timestamp.getTime() < e.getTime() && (e = h.timestamp) : h.timestamp.getTime() < e.getTime() && (e = h.timestamp));
...
return console.error("formatChoice error : ", l), "";
}
};
;
...
return b;
}, enyo.g11n.Resources.prototype.$L = function(a) {}, enyo.g11n.Resources.prototype._$L = function(a) {
var b, c;
return a ? this.locale.equals(enyo.g11n.sourceLocale()) ? typeof a == "string" ? a : a.value : (this.strings || this._loadStrings(), typeof a == "string" ? (b = a, c = a) : (b = a.key, c = a.value), this.strings && typeof this.strings[b] != "undefined" ? this.strings[b] : c) : "";
}, enyo.g11n.Resources.prototype._pseudo = function(a) {
var b, c;
if (!a) return "";
c = "";
for (b = 0; b < a.length; b++) if (a.charAt(b) === "#" && b + 1 < a.length && a.charAt(b + 1) === "{") {
while (a.charAt(b) !== "}" && b < a.length) c += a.charAt(b++);
b < a.length && (c += a.charAt(b));
} else if (a.charAt(b) === "<") {
while (a.charAt(b) !== ">" && b < a.length) c += a.charAt(b++);
b < a.length && (c += a.charAt(b));
} else if (a.charAt(b) === "&" && b + 1 < a.length && !enyo.g11n.Char.isSpace(a.charAt(b + 1))) {
while (a.charAt(b) !== ";" && !enyo.g11n.Char.isSpace(a.charAt(b)) && b < a.length) c += a.charAt(b++);
b < a.length && (c += a.charAt(b));
} else c += enyo.g11n.Resources._pseudoMap[a.charAt(b)] || a.charAt(b);
return c;
...
enyo.g11n.Char = enyo.g11n.Char || {}, enyo.g11n.Char._strTrans = function a(a, b) {
var c = "", d, e;
...
return a >= 19968 && a <= 40907 || a >= 63744 && a <= 64217 || a >= 13312 && a <= 19893 || a >= 12353 && a <= 12447 || a >= 12449 && a <= 12543 || a >= 65382 && a <= 65437 || a >= 12784 && a <= 12799 || a >= 12549 && a <= 12589 || a >= 12704 && a <= 12727 || a >= 12593 && a <= 12686 || a >= 65440 && a <= 65500 || a >= 44032 && a <= 55203 || a >= 40960 && a <= 42124 || a >= 4352 && a <= 4607 || a >= 43360 && a <= 43388 || a >= 55216 && a <= 55291 ? !0 : !1;
}, enyo.g11n.Char._isIdeoOther = function(a) {
return a >= 42125 && a <= 42191 || a >= 12544 && a <= 12548 || a >= 12590 && a <= 12591 || a >= 64218 && a <= 64255 || a >= 55292 && a <= 55295 || a >= 40908 && a <= 40959 || a >= 43389 && a <= 43391 || a >= 12800 && a <= 13055 || a >= 13056 && a <= 13183 || a >= 13184 && a <= 13311 || a === 12592 || a === 12687 || a === 12448 || a === 12352 || a === 12294 || a === 12348 ? !0 : !1;
}, enyo.g11n.Char.isIdeo = function b(a) {
var b;
return !a || a.length < 1 ? !1 : (b = a.charCodeAt(0), enyo.g11n.Char._isIdeoLetter(b) || enyo.g11n.Char._isIdeoOther(b));
}, enyo.g11n.Char.isPunct = function c(a) {
var b, c;
return !a || a.length < 1 ? !1 : (b = enyo.g11n.Utils.getNonLocaleFile({
root: enyo.g11n.Utils._getEnyoRoot(),
path: "base/character_data/chartype.punct.json"
}), c = b && a.charAt(0) in b, enyo.g11n.Utils.releaseAllJsonFiles(), c);
...
8287: 1,
12288: 1
}, enyo.g11n.Char.isSpace = function(a) {
var b;
return !a || a.length < 1 ? !1 : (b = a.charCodeAt(0), b in enyo.g11n.Char._space);
}, enyo.g11n.Char.toUpper = function(a, b) {
var c;
...
return c && c.upperMap !== undefined ? enyo.g11n.Char._strTrans(a, c.upperMap) : (enyo.g11n.Utils.releaseAllJsonFiles(), a);
}, enyo.g11n.Char.isLetter = function(a) {
var b, c, d, e;
return !a || a.length < 1 ? !1 : (b = a.charAt(0), c = a.charCodeAt(0), d = enyo.g11n.Utils.getNonLocaleFile({
root: enyo.g11n.Utils._getEnyoRoot(),
path: "base/character_data/chartype.letter.json"
}), e = d && b in d || enyo.g11n.Char._isIdeoLetter(c), enyo.g11n.Utils.releaseAllJsonFiles(), e);
}, enyo.g11n.Char.getIndexChars = function(a) {
var b, c, d, e, f = [];
...
return f;
}, enyo.g11n.Char.getBaseString = function(a, b) {
var c, d;
if (!a) return undefined;
...
return c && c.baseChars !== undefined && (a = enyo.g11n.Char._strTrans(a, c.baseChars)), enyo.g11n.Utils.releaseAllJsonFiles(), a;
};
;
// g11n/base/javascript/timezone.js

enyo.g11n._TZ = enyo.g11n._TZ || {}, enyo.g11n.TzFmt = function(a) {
return this.setTZ(), a !== undefined && a.TZ !== undefined && this.setCurrentTimeZone(a.TZ), enyo.g11n.Utils.releaseAllJsonFiles(), this;
...
return a.date && b && (d = f._normalizedComponents.date[b], d === undefined && (console.log("date component error: '" + b + "'"), d = "")), h && c !== undefined && (g = f._normalizedComponents.timeLength[h], g === undefined && (console.log("time format error: " + h), g = "small"), e = f._normalizedComponents.time[c], e === undefined && console.log("time component error: '" + c + "'")), a.dateComponents = d, a.timeComponents = e, a;
...
if (a !== "full" && b.weekday) {
var d = f._formatFetch(b.weekday === !0 ? a : b.weekday, "", "Weekday");
...
var c;
return b = f._roundToMidnight(b), a = f._roundToMidnight(a), c = (a.getTime() - b.getTime()) / 864e5, c;
}, f._roundToMidnight = function(a) {
var b = a.getTime(), c = new Date;
return c.setTime(b), c.setHours(0), c.setMinutes(0), c.setSeconds(0), c.setMilliseconds(0), c;
}, f.inputParams = a, typeof a == "undefined" || !a.locale ? b = enyo.g11n.formatLocale() : typeof a.locale == "string" ? b = new enyo.g11n.Locale(a.locale) : b = a.locale, b.language || b.useDefaultLang(), this.locale = b, typeof a == "string" ? f.formatType = a : typeof a == "undefined" ? (a = {
format: "short"
...
var b = this;
return typeof a != "object" || b.tokenized === null ? (console.warn("DateFmt.format: no date to format or no format loaded"), undefined) : this._format(a, b.tokenized);
...
var c, d, e, f, g, h, i, j, k = this.partsLength || "medium", l = this.dateTimeHash, m = this.dateTimeFormatHash;
return !a && !b ? "" : !a || !b ? this.format(a || b) : (b.getTime() < a.getTime() && (c = b, b = a, a = c), i = new Date(a.getTime()), i.setHours(0), i.setMinutes(0), i.setSeconds(0), i.setMilliseconds(0), j = new Date(b.getTime()), j.setHours(0), j.setMinutes(0), j.setSeconds(0), j.setMilliseconds(0), j.getTime() - i.getTime() === 864e5 ? (f = "shortTime" + (this.twelveHourFormat ? "12" : "24"), d = this._getTokenizedFormat(m[f]), f = k + "Date", e = this._getTokenizedFormat(m[f]), h = new enyo.g11n.Template(this.rb.$L({
...
})) : a.getYear() === b.getYear() ? (g = k === "short" || k === "single" ? (a.getFullYear() + "").substring(2) : a.getFullYear(), a.getMonth() === b.getMonth() ? a.getDate() === b.getDate() ? (f = "shortTime" + (this.twelveHourFormat ? "12" : "24"), d = this._getTokenizedFormat(m[f]), f = k + "Date", e = this._getTokenizedFormat(m[f]), h = new enyo.g11n.Template(this.rb.$L({
...
})) : (f = k + "DDate", e = this._getTokenizedFormat(m[f]), h = new enyo.g11n.Template(this.rb.$L({
key: "dateRangeWithinMonth",
value: "#{month} #{startDate}-#{endDate}, #{year}"
})), h.evaluate({
month: l[k].month[a.getMonth()],
startDate: this._format(a, e),
endDate: this._format(b, e),
year: g
})) : (k === "full" ? k = "long" : k === "single" && (k = "short"), f = k + "DMDate", e = this._getTokenizedFormat(m[f]), h = new enyo.g11n.Template(this.rb.$L({
...
year: g
}))) : b.getYear() - a.getYear() < 2 ? (f = k + "Date", e = this._getTokenizedFormat(m[f]), h = new enyo.g11n.Template(this.rb.$L({
key: "dateRangeWithinConsecutiveYears",
value: "#{start} - #{end}"
})), h.evaluate({
start: this._format(a, e),
end: this._format(b, e)
})) : (k === "full" ? k = "long" : k === "single" && (k = "short"), f = k + "MYDate", e = this._getTokenizedFormat(m[f]), h = new enyo.g11n.Template(this.rb.$L({
...
var b, c, d, e, f, g, h;
typeof a == "number" ? this.fractionDigits = a : a && typeof a.fractionDigits == "number" && (this.fractionDigits = a.fractionDigits), !a || !a.locale ? this.locale = enyo.g11n.formatLocale() : typeof a.locale == "string" ? this.locale = new enyo.g11n.Locale(a.locale) : this.locale = a.locale, this.style = a && a.style || "number", b = enyo.g11n.Utils.getJsonFile({
root: enyo.g11n.Utils._getEnyoRoot(),
path: "base/formats",
locale: this.locale,
type: "region"
...
return c[0] = d, e = c.join(this.decimal), this.style === "currency" && this.currencyTemplate ? e = this.currencyTemplate.evaluate({
amt: e,
sign: this.sign
}) : this.style === "percent" && (e += this.percentageSpace ? " %" : "%"), e;
} catch (f) {
return console.log("formatNumber error : " + f), (a || "0") + "." + (this.fractionDigits || "");
}
};
;
...
return d.length > 2 && this.style === "full" && (d[d.length - 2] = this.parts.finalSeparator), d.join("") || "";
};
;
// dom/dom.js
...
return b.target || (b.target = b.srcElement), b.handled = enyo._stopEvent, b;
...
if (b) {
var d = b && b.getBoundingClientRect();
d && (c.left -= d.left, c.right -= d.left, c.top -= d.top, c.bottom -= d.top);
}
return c;
},
...
var d = a;
if (d.style) {
var e = this.calcNodeOffset(d), f = b - e.left, g = c - e.top;
...
return console.log("returning target " + d.id), d;
}
...
return a = a * 2, a < 1 ? Math.pow(a, 2) / 2 : -1 * (--a * (a - 2) - 1) / 2;
},
linear: function(a) {
return a;
}
...
return a === "" ? a : typeof PalmSystem != "undefined" && PalmSystem.runTextIndexer ? PalmSystem.runTextIndexer(a, b) : (console.warn("enyo.string.runTextIndexer is not available on your system"), a);
},
toBase64: function(a) {
...
return console.error("Your browser does not support native base64 operations"), a;
};
...
return d.pop(), d.push(b), d.join("/");
}, enyo._$L = function(a) {
return this._enyoG11nResources || (this._enyoG11nResources = new enyo.g11n.Resources({
root: "$enyo"
})), this._enyoG11nResources.$L(a);
...
return b.height -= Math.max(0, c - d), b;
}, enyo.getModalBounds = function() {
return {
width: window.innerWidth,
height: window.innerHeight
};
}, enyo.findControlForNode = function(a) {
var b, c = a;
try {
while (c) {
if (b = enyo.$[c.id]) break;
c = c.parentNode;
}
} catch (d) {
console.log(d, c);
...
console.error("enyo.xhr.request() exception: " + (f + "")), b = undefined;
}
return b;
},
...
play: function() {
return this.easingFunc = this.easingFunc || enyo.easing.linear, this.repeated = 0, this.value = this.start, this.animating && this.stop(), enyo.call(this, "onBegin", [ this.start, this.end ]), this.t0 = this.t1 = Date.now(), this.animating = !0, this.animate(), this;
},
...
stop: function() {
if (this.animating) return this.cancelFrame(), enyo.call(this, "onStop", [ this.value, this.start, this.end ]), this;
},
animate: function() {
...
return (a.type == "windowDeactivated" || a.type == "windowHidden") && this.broadcastMessage("autoHide"), this.broadcastEvent(a);
},
...
var b = !1;
for (var c = 0, d; d = this.listeners[c]; c++) b = d.dispatchDomEvent(a) || b;
return b;
},
...
focusByEvent: function(a) {
var b = a.dispatchTarget;
this.focusNode(b.requiresNodeFocus ? b.hasNode() : a.target);
},
focusNode: function(a) {
var b = document.activeElement;
b != a && (b && b.blur(), a && a.focus && a.focus());
},
requiresDomMousedown: function(a) {
return a.dispatchTarget.requiresDomMousedown;
},
mousedown: function(a) {
if (this._isFocusing) return a.target != this.targetEvent.target && a.preventDefault(), !0;
...
mouseup: function(a) {
if (this._isFocusing) return this._isFocusing = !1, !0;
if (!a.synthetic) {
this.stopTracking();
var b = Boolean(this.dragEvent);
return this.didDrag = this.stopDragging(a) || this._didDomGesture, this._didDomGesture = !1, this.stopMousehold(), this.tryFocus(a, b), !this.didDrag && this.sendCustomClick(a);
}
},
gesturestart: function(a) {
this._didDomGesture = !0;
},
tryFocus: function(a, b) {
var c = this.targetEvent, d = this.requiresDomMousedown(c);
a.didDrag = b;
var e = a.mousedownPrevented = c.prevented || d && c.defaultPrevented;
!b && !e && !d && this.focusByEvent(c);
},
sendCustomClick: function(a) {
if (this.target !== a.target) {
var b = this._findCommonAncestor(this.dispatchTarget, a.dispatchTarget);
if (b) return a.synthetic = !0, enyo.dispatch(a), this.send("click", a, {
synthetic: !0,
target: b.hasNode()
}), !0;
}
...
click: function(a) {
if (this.didDrag && !a.dispatchTarget.requiresDomClick) return this.didDrag = !1, !0;
},
...
window.PalmSystem && (PalmSystem.useSimulatedMouseClicks && PalmSystem.useSimulatedMouseClicks(!0), enyo.gesture.focusAtPoint = function(a) {
enyo.gesture._isFocusing = !0, PalmSystem.simulateMouseClick(a.pageX, a.pageY, !0), PalmSystem.simulateMouseClick(a.pageX, a.pageY, !1);
}, enyo.gesture.requiresDomMousedown = function(a) {
return a.dispatchTarget.requiresDomMousedown || a.detail == 2;
}, enyo.gesture.focusByEvent = function(a) {
enyo.keyboard.suspend();
var b = a.dispatchTarget;
this.focusNode(b.requiresNodeFocus ? b.hasNode() : a.target), enyo.keyboard.resume(), this.focusAtPoint(a);
});
});
;
// dom/DomNode.js
...
return c && (b += ' style="' + c + '"'), this.nodeTag == "img" ? b += "/>" : b += ">" + a + "</" + this.nodeTag + ">", this.generated = !0, b;
},
...
return c.height !== "auto" && c.height !== "0px" ? this.addClass(enyo.fittingClassName) : b == document.body && this.addClass(enyo.fittingClassName), b.innerHTML = this.generateHtml(), this.rendered(), this;
},
rendered: function() {},
show: function() {
this.setShowing(!0);
...
getInnerHtml: function() {
return this.flow(), this.getChildContent() || this.content;
},
render: function() {
...
var d = a.domStyles;
return a.flex ? a.flex : d[b] == "100%" || a[c] == "fill" ? (delete d[b], a.flex = 1) : null;
},
...
this.dragging || this.$.scroll.mousewheel(b);
}
});
;
...
var c = this.getBoundaries();
b.left -= Math.max(c.left, Math.min(c.right, this.scrollLeft)), b.top -= Math.max(c.top, Math.min(c.bottom, this.scrollTop));
}
return b;
},
...
resizeHandler: function() {
this.stabilize(), this.inherited(arguments);
},
...
stop: function() {
if (this.isScrolling()) {
var a = this.$.scroll.isInOverScroll();
this.$.scroll.stop(), a && this.stabilize();
}
},
dragstartHandler: function(a, b) {
return this.calcBoundaries(), this.calcAutoScrolling(), this.inherited(arguments);
},
...
scroll: function(a) {
this.scrollLeft = -a.x, this.scrollTop = -a.y, this.doBeforeScroll(), this.effectScroll(), this.doScroll();
},
scrollStop: function(a) {
this.fpsShowing && this.$.fps.setContent(a.fps);
if (this.needsOffsetBroadcast || this.scrollLeft != this.scrollLeftStart || this.scrollTop != this.scrollTopStart) this.broadcastToControls("offsetChanged"), this.needsOffsetBroadcast = !1;
this.doScrollStop();
},
...
b.top = a.top = -Math.round(this.scrollTop) + "px", b.left = a.left = -Math.round(this.scrollLeft) + "px";
}
},
...
var a = this.$.scroll;
a.x = a.x0 = -this.scrollLeft, this.scrollee && (this.needsOffsetBroadcast = !0, this.start());
},
scrollTopChanged: function() {
var a = this.$.scroll;
a.y = a.y0 = -this.scrollTop, this.scrollee && (this.needsOffsetBroadcast = !0, this.start());
},
stabilize: function() {
this.calcBoundaries();
var a = this.$.scroll, b = Math.min(a.topBoundary, Math.max(a.bottomBoundary, a.y)), c = Math.min(a.leftBoundary, Math.max(a.rightBoundary, a.x));
if (b != a.y || c != a.x) a.y = a.y0 = b, a.x = a.x0 = c, this.scrollStart(a), this.scroll(a), this.scrollStop(a);
},
...
(a < this.scrollTop || a > this.scrollTop + d) && this.setScrollTop(Math.max(c.top, Math.min(c.bottom, a))), (b < this.scrollLeft || b > this.scrollLeft + e) && this.setScrollLeft(Math.max(c.left, Math.min(c.right, b)));
}
this.start();
},
...
initComponents: function() {
!this.components || this.components.length !== 1 ? (this.controlParentName = "innerClient", this.createChrome(this.multiChrome)) : this.createChrome(this.monoChrome), this.inherited(arguments);
},
locateScrollee: function() {
...
this.snapPos = a, this.pos = a, this.snapping = !0, this.snapable = !1, this.scrollH ? this.scrollTo(0, a) : this.scrollTo(a, 0);
},
...
b && (b != this.node || this.needsNode) && (this.setNode(b), this.doNodeChange(b), this.needsNode = !1);
},
findNode: function(a) {
var b = a;
while (b) {
...
if (b) {
if (!a._hasNode) return a._hasNode = a.hasNode, a.hasNode = enyo.nop, !0;
} else if (a._hasNode) return a.hasNode = a._hasNode, delete a._hasNode, !0;
},
...
for (var b = 0, c = a.children, d, e; d = c[b]; b++) e = this.findControlNode(d, a.node, b), e ? (d.node = e, this.assignChildrenNodes(d)) : d.teardownRender();
},
findControlNode: function(a, b, c) {
var d = a.id, e = b && b.childNodes[c];
return e && e.id == d ? e : b && b.querySelector("[id=" + d + "]");
}
...
var a = {};
return this.read(this.control, a), a;
},
getDefaultState: function() {
return this.defaultState || (this.defaultState = this.makeDefaultState()), this.copyState(this.defaultState);
},
clear: function() {
this.state = [];
},
...
var b = enyo.clone(a);
return b.domStyles = enyo.clone(b.domStyles), b.domAttributes = enyo.clone(b.domAttributes), this.copyChildrenState(b, a), b;
},
...
return b || this.disableNodeAccess(), b;
},
generateHtml: function() {
return "";
},
...
return c !== undefined && (c === null ? b = " " : c && (this.$.client.domAttributes.rowIndex = a, b = this.getChildContent(), this.$.state.save(a))), this.$.client.needsNode = !0, b;
},
...
if (b) return this.$.client.setNode(b), !0;
},
...
getChildContent: function() {
return this.build(), this.inherited(arguments);
},
build: function() {
...
if (!this.disabled) return this.setDown(!0), this.doMousedown(b);
},
mouseupHandler: function(a, b) {
if (!this.disabled && this.down) return this.setDown(!1), this.doMouseup(b);
},
flickHandler: function(a, b) {
...
if (this.allowDrag) this.setDown(!1); else return this.drag = !this.disabled, !0;
},
...
return c ? (this.doLinkClick(c, b), b.preventDefault(), !0) : b.didDrag ? !0 : this.doClick();
}
});
;
...
mousedownHandler: function(a, b) {
return this.disabled && b.preventDefault(), this.fire("mousedown", b);
},
...
return this.didFocus = !0, this.hasNode() && this.isEmpty() && this.updatePlaceholder(!1), this.disabled ? !0 : this.doFocus();
},
blurHandler: function(a, b) {
return this.didFocus = !1, this.isEmpty() && this.updatePlaceholder(!0), this.doBlur();
},
...
b ? this.applyFocus(a) : enyo.asyncMethod(this, "applyFocus", a);
},
applyFocus: function(a) {
this.hasNode() && (this.node.focus(), a && a());
},
forceBlur: function(a, b) {
b ? this.applyBlur(a) : enyo.asyncMethod(this, "applyBlur", a);
},
applyBlur: function(a) {
this.hasNode() && (this.node.blur(), a && a());
},
forceSelect: function(a, b) {
b ? this.applySelect(a) : enyo.asyncMethod(this, "applySelect", a);
},
applySelect: function(a) {
this.hasNode() && (this.node.select(), a && a());
},
hasFocus: function() {
if (this.hasNode()) return Boolean(this.node.parentNode.querySelector(this.nodeTag + ":focus"));
}
}), enyo.requiresWindow(function() {
window.PalmSystem && (enyo.BasicInput.prototype.requiresDomMousedown = !1);
});
;
...
mousedownHandler: function(a, b) {
var c = this.doMousedown(b);
return this.chromeMousedown = b.dispatchTarget != this.$.input ? b : null, this.chromeMousedown && this.handleChromeMousedown(b), c;
},
handleChromeMousedown: function(a) {
a.chromeEventPrevented = a.prevented, a.preventDefault(), a.preventDefault = function() {
a.chromeEventPrevented = !0;
};
},
focusHandler: function(a, b) {
return this.styled && !this.alwaysLooksFocused && this.addClass(this.focusClassName), this.selectAllOnFocus && this.forceSelect(), this.doFocus(b);
},
mouseupHandler: function(a, b) {
return this.chromeMousedown && !this.disabled && !b.didDrag && !this.chromeMousedown.chromeEventPrevented && this.forceFocus(null, !0), this.doMouseup(b);
},
blurHandler: function(a, b) {
return this.alwaysLooksFocused || this.removeClass(this.focusClassName), this.selectAllOnFocus && document.execCommand("Unselect"), this.doBlur(b);
},
clickHandler: function(a, b) {
...
changeHandler: function(a, b) {
return this.changeOnInput || (this.value = a.getValue(), this.doChange(b, this.value)), !0;
},
...
return this.doChange(b, this.getValue()), c;
},
isEmpty: function() {
...
return a = a.replace(/<br>$/, ""), a == this.placeholder ? "" : a;
},
setDomValue: function(a) {
this.hasFocus() ? (this.selectAll(), this.insertAtCursor(a)) : this.setContent(a);
},
getDomValue: function() {
return enyo.string.trim(this.richContent ? this.getHtml() : this.getText());
},
valueChanged: function() {
this.setDomValue(this.value), this.isEmpty() && !this.didFocus && this.updatePlaceholder(!0);
},
contentChanged: function() {
var a = this.content;
...
this.addRemoveClass("enyo-richtext-plaintext", !this.richContent), this.allowHtml = this.richContent, this.richContent || this.setDomValue(this.hasNode() ? this.getText() : this.value || this.placeholder);
},
applySelect: function(a) {
this.hasNode() && (this.node.focus(), this.selectAll(), a && a());
},
getSelection: function() {
...
if (this.hasFocus()) {
var b = this.allowHtml ? a : enyo.string.escapeHtml(a).replace(/\n/g, "<br/>");
document.execCommand("insertHTML", !1, b);
}
}
}), enyo.requiresWindow(function() {
window.PalmSystem && (enyo.BasicRichText.prototype.requiresDomMousedown = !1);
});
;
...
removeSelection: function(a) {
this.$.input.removeSelection(a);
},
modifySelection: function(a, b, c) {
this.$.input.modifySelection(a, b, c);
},
moveCursor: function(a, b) {
this.$.input.moveCursor(a, b);
},
moveCursorToEnd: function() {
...
showingChanged: function() {
this.inherited(arguments), this.showing ? this.tabIndexChanged() : this.applyTabIndex(-1);
},
urlChanged: function() {
this.setAttribute("src", this.url);
},
tabIndexChanged: function() {
this.showing && this.applyTabIndex(this.tabIndex);
},
applyTabIndex: function(a) {
this.domAttributes.tabIndex = a;
},
goBack: function() {
...
kind: enyo.Control,
create: function() {
this.inherited(arguments), this.generated = !0;
},
hasNode: function() {
...
if (this.canOpen()) return this.isOpen = !0, enyo.BasicPopup.count++, this.modal && enyo.BasicPopup.modalCount++, this.applyZIndex(), this._didOpenMousedown = !1, this.validateComponents(), this.doBeforeOpen(!this.hasOpened), this.hasOpened = !0, this.generated || this.render(), this.dispatcher.capture(this, !this.modal), !0;
},
finishOpen: function() {
...
this.showing && (enyo.BasicPopup.count--, this.modal && enyo.BasicPopup.modalCount--), this.blurContents(), this.broadcastToControls("hidden"), this.dispatcher.release(), this._zIndex = null, this.applyStyle("z-index", null);
},
renderClose: function() {
this.hide();
},
blurContents: function() {
var a = enyo.findFocusedControl();
a && a.isDescendantOf(this) && a.hasNode() && a.node.blur();
},
...
getScrim: function() {
return this.modal && this.scrimWhenModal && !this.scrim ? enyo.scrimTransparent.make() : this.shareScrim ? enyo.scrim.make() : (this.$.scrim || (this.createComponent({
name: "scrim",
kind: "Scrim",
parent: this.parent
}), this.$.scrim.render()), this.$.scrim);
},
...
if (this.dismissWithClick && !b.dispatchTarget.isDescendantOf(this)) b.dispatchTarget != enyo.dispatcher.rootHandler && this.close(b, "popup:click"); else {
var c = this.findPopupHandler(a);
c && this.close(b, c.popupHandler);
}
},
blurHandler: function(a, b) {
return this.lastFocus = a, this.fire("blur", b);
},
focusHandler: function(a, b) {
...
return this.fire("focus", b);
},
keydownHandler: function(a, b, c) {
switch (b.keyCode) {
case 27:
return this.dismissWithEscape && (this.close(b, "popup:escape"), enyo.stopEvent(b)), !0;
}
},
...
applyBounds: function(a, b) {
var c = a || {};
b && (c = this.clampPosition(enyo.mixin(c, this.calcSize()))), this.applyPosition(c), this.applyClampedSize(c);
},
...
return c.right ? b.right = Math.max(0, Math.min(d.width - c.width, c.right)) : b.left = Math.max(0, Math.min(d.width - c.width, c.left)), c.bottom ? b.bottom = Math.max(0, Math.min(d.height - c.height, c.bottom)) : b.top = Math.max(0, Math.min(d.height - c.height, c.top)), b;
},
...
return d.height -= b.height, d.width -= b.width, d;
},
...
var a;
return this.parent && this.parent.hasNode() ? a = enyo.calcModalControlBounds(this.parent) : a = enyo.getModalBounds(), this._viewport = a;
},
calcSize: function() {
...
return a.height = a.offsetHeight = this.node.offsetHeight, a.width = a.offsetWidth = this.node.offsetWidth, a.clientHeight = this.node.clientHeight, a.clientWidth = this.node.clientWidth, this.finishMeasureSize(), this._size = a;
}
},
...
animateShowing: !0,
create: function() {
this.inherited(arguments), this.zStack = [], this.animateShowing = this.animateShowing && this.showingClassName, this.transparent && (this.showingClassName = "enyo-scrim-transparent", this.animateShowing = !1);
},
rendered: function() {
this.inherited(arguments), this.addListeners();
},
...
showingChanged: function() {
!this.generated && this.showing && (this.flow(), this.renderNode()), this.inherited(arguments), enyo.asyncMethod(this, "addRemoveShowingClassName", this.showing);
},
webkitTransitionEndHandler: function() {
this.showing || (this._endingTransition = !0, this.setShowing(!1), this._endingTransition = !1);
},
addRemoveShowingClassName: function(a) {
this.addRemoveClass(this.showingClassName, a);
},
...
make: function() {
var a = enyo.mixin(this.props, {
parent: enyo.getPopupLayer()
}), b = new enyo.Scrim(a);
return enyo.setObject(this.instanceName, b), b.renderNode(), b;
},
show: function() {
var a = this.make();
a.show();
...
hide: enyo.nop,
destroy: enyo.nop
}), new enyo.scrimSingleton("enyo.scrim"), new enyo.scrimSingleton("enyo.scrimTransparent", {
showingClassName: "enyo-scrim-transparent",
animateShowing: !1
});
;
...
return a = Math.max(this.minimum, Math.min(this.maximum, a)), Math.round(a / this.snap) * this.snap;
},
calcRange: function() {
...
getInnerHtml: function() {
return this.flow(), this.inherited(arguments);
}
}), enyo.kind({
name: "enyo.HBox",
kind: enyo.Box,
...
this.hasNode() ? this.node.style.display = "" : this.applyStyle("display", ""), this.animate && this.hasNode() ? this.playAnimation() : (this.applyStyle("height", this.open ? "auto" : "0px"), this.applyStyle("display", this.open ? null : "none")), a !== undefined && this.open !== a && this.doOpenChanged();
},
...
getInnerHtml: function() {
return this.finishTransition(), this.flow(), this.inherited(arguments);
},
...
return c && this.selectView(c, b), c;
},
...
if (a) return this.transitionView(a.from, a.to), !0;
},
...
this.audio && (this.audioClass ? this.audio.setAttribute("x-palm-media-audio-class", this.audioClass) : this.audio.removeAttribute("x-palm-media-audio-class"));
},
play: function() {
...
nodeTag: "video",
create: function() {
this.inherited(arguments), this.srcChanged(), this.showControlsChanged(), this.autoplayChanged(), this.loopChanged();
},
rendered: function() {
...
srcChanged: function() {
var a = enyo.path.rewrite(this.src);
this.setAttribute("src", a), this.hasNode() && this.node.load();
},
...
var a = this.node.getAttribute("x-palm-media-control");
a && this.$.mediad.call({
...
resizesWindow: !0,
positiveSpaceChanged: function(a, b) {
...
enyo.call(a, "scrollOffsetIntoView", [ b.y, b.x, b.height ]);
}
},
...
keyboardShown: function(a) {
a.showing || enyo.asyncMethod(enyo.keyboard, "resetScroller");
}
...
a !== 0 && b !== 0 && enyo.keyboard.positiveSpaceChanged(a, b);
}, Mojo.keyboardShown = function(a) {
enyo.keyboard._isShowing = a, enyo.dispatch({
type: "keyboardShown",
showing: a
});
}, enyo.dispatcher.features.push(function(a) {
if (enyo.keyboard.events[a.type]) return enyo.keyboard[a.type](a);
}), window.PalmSystem && PalmSystem.setManualKeyboardEnabled && (enyo.keyboard.setResizesWindow = function(a) {
this.resizesWindow = a, this.resizesWindow && (enyo.keyboard.modalBounds = null), PalmSystem.allowResizeOnPositiveSpaceChange ? PalmSystem.allowResizeOnPositiveSpaceChange(a) : console.log("Keyboard resizing cannot be changed.");
...
if (h) console.warn('Window "' + b + '" already exists, activating it'), this.activateWindow(h, c); else {
if (c) {
var i = enyo.fetchAppRootPath();
if (a[0] === "/" && a.indexOf(i.slice(7)) !== 0 || a.indexOf("file:///") === 0 && a.indexOf(i) !== 0) a = a + "?enyoWindowParams=" + encodeURIComponent(enyo.json.stringify(c));
}
h = this.agent.open(g, a, b || "", f, e), this.finishOpenWindow(h, c), this.manager.setPendingParamsList(h, []);
}
return h;
},
...
return this.agent.isValidWindowName(b) && (!d || d == a) ? b : this.calcUniqueWindowName();
},
...
return d = d || {}, d.window = "dashboard", this.openWindow(a, b, c, d);
},
openPopup: function(a, b, c, d, e, f) {
d = d || {}, d.window = "popupalert";
var g = this.openWindow(a, b, c, d, "height=" + (e || 200));
return f && g.PalmSystem && g.PalmSystem.addNewContentIndicator(), g;
},
activate: function(a, b, c, d, e) {
var f = this.fetchWindow(b);
return f ? this.activateWindow(f, c) : a && (f = this.openWindow(a, b, c, d, e)), f;
},
...
addBannerMessage: function(a, b, c, d, e, f) {
...
var c = this.manager.getPendingParamsList(a);
c ? c.push(b) : a.postMessage("enyoWindowParams=" + enyo.json.stringify(b), "*");
},
...
var c = this.manager.getPendingParamsList(a);
return this.manager.removeWindow(a), a.name = enyo.windows.ensureUniqueWindowName(a, b), this.manager.addWindow(a), this.manager.setPendingParamsList(a, c), a.name;
}
};
;
...
return k.name = c, k.close = function() {
...
if (b && a["palm-command"] == "open-app-menu" && b.enyo) return b.enyo.appMenu.toggle(), !0;
},
...
return this.handleAppMenu(b) ? !0 : (enyo.windows.assignWindowParams(a, b), enyo.windows.setWindowParams(a, b), this.dispatchApplicationRelaunch(a));
},
...
for (var c in a) {
b = a[c];
if (b.PalmSystem && b.PalmSystem.isActivated) return b;
}
},
...
var b = a.enyo;
b && (b.application = (b.windows.getRootWindow().enyo || b).application || {});
},
...
var c = "enyoWindowParams=";
b.data.indexOf(c) === 0 ? (enyo.windows.assignWindowParams(window, b.data.slice(c.length)), enyo.windows.events.dispatchWindowParamsChange(window)) : b.data === "enyoWindowReady" && a.executePendingWindowParams(b.source);
}, !1);
}
}, enyo.requiresWindow(function() {
...
b.addUnloadListener(), b.addLoadListener(), b.addMessageListener(), (window.opener || window.parent).postMessage("enyoWindowReady", "*"), b.setupApplication(window);
});
;
...
create: function() {
this.inherited(arguments), this.layers = [], this.dashboardId = Math.random(), this.handleMessageHitched = enyo.hitch(this, "handleMessage"), window.addEventListener("message", this.handleMessageHitched);
},
destroy: function() {
...
this.smallIcon && (c.icon = this.smallIcon), this.window = enyo.windows.openDashboard(enyo.path.rewrite(this.indexPath), this.name, b, c);
} else enyo.windows.activate(undefined, this.name, b);
} else a && this.window.close(), this.window = undefined;
},
handleMessage: function(a) {
if (!this.window) return;
var b = a.source === this.window || a.source === undefined && this.window.closed !== !1;
if (!b) return;
var c = "enyoDashboardEvent=";
if (a.data.indexOf(c) !== 0) return;
var d = enyo.json.parse(a.data.slice(c.length));
if (d.dashboardId !== this.dashboardId || !d.event || d.event.indexOf("do") !== 0 || !this[d.event]) return;
switch (d.event) {
case "doLayerSwipe":
this.layers.pop(), this.doLayerSwipe.apply(this, d.args);
break;
case "doUserClose":
this.layers.length = 0, this.window = undefined, this.doUserClose();
break;
default:
this[d.event].apply(this, d.args);
}
}
});
;
...
if (!b || !b.returnValue) {
console.error("Could not get app path: " + (b && b.errorText));
return;
}
this.appPath = b.basePath, this.appPath = this.appPath || "", this.appPath && (this.appPath = this.appPath.slice(0, this.appPath.lastIndexOf("/") + 1), this.pathChanged());
},
...
return this.updateIconClass(), this.inherited(arguments);
},
...
chrome: [ {
name: "bar",
className: "enyo-toggle-button-bar",
components: [ {
name: "labelOn",
nodeTag: "span",
...
this.$.bar.setClassName("enyo-toggle-button-bar " + (this.state ? "on" : "off")), this.$.labelOn.applyStyle("display", this.state ? "inline" : "none"), this.$.labelOff.applyStyle("display", this.state ? "none" : "inline");
},
disabledChanged: function() {
this.$.bar.addRemoveClass("disabled", this.disabled), this.$.labelOn.addRemoveClass("enyo-disabled", this.disabled), this.$.labelOff.addRemoveClass("enyo-disabled", this.disabled);
},
...
a.width && a.height && this.callBrowserAdapter("setVisibleSize", [ a.width, a.height ]);
},
urlChanged: function() {
...
flickHandler: function(a, b) {
return this.callBrowserAdapter("handleFlick", [ b.xVel, b.yVel ]), !0;
},
...
systemRedirectsChanged: function(a) {
this._redirectsChanged(this.systemRedirects, a);
},
redirectsChanged: function(a) {
this._redirectsChanged(this.redirects, a);
},
_redirectsChanged: function(a, b) {
for (var c = 0, d; d = b && b[c]; c++) this.callBrowserAdapter("addUrlRedirect", [ d.regex, !1, d.cookie, d.type || 0 ]);
for (c = 0, d; d = a[c]; c++) this.callBrowserAdapter("addUrlRedirect", [ d.regex, d.enable, d.cookie, d.type || 0 ]);
},
...
var a = this.dnsServers.join(",");
this.callBrowserAdapter("setDNSServers", [ a ]);
}
},
...
dialogSSLConfirm: function(a, b, c) {
this.doSSLConfirmDialog(a, b, c);
},
...
_cachedSelectPopups: {},
create: function(a) {
this.chrome[0].cacheAdapter = a.cacheAdapter, this.inherited(arguments), this.identifierChanged(), this.minFontSizeChanged(), this.enableJavascriptChanged(), this.blockPopupsChanged(), this.acceptCookiesChanged(), this.headerHeightChanged(), this.addSystemRedirects(), this.redirectsChanged(), this.networkInterfaceChanged(), this.ignoreMetaTagsChanged(), this.urlChanged();
},
...
handleDialog: function(a, b) {
var c = this["on" + a];
if (this.owner && this.owner[c]) {
var d = Array.prototype.slice.call(b, 1);
this["do" + a].apply(this, d);
...
gotSystemRedirects: function(a, b) {
var c = b && enyo.json.parse(b.responseText), d = [];
for (var e = 0, f; c && c.redirects && (f = c.redirects[e]); e++) f.appId != enyo.fetchAppId() && d.push({
regex: f.url,
enable: !0,
cookie: f.appId,
type: 0
});
for (e = 0, f; c && c.commands && (f = c.commands[e]); e++) f.appId != enyo.fetchAppId() && f.appId != "com.palm.app.browser" && d.push({
regex: f.url,
enable: !0,
cookie: f.appId,
type: 1
});
this.$.view.setSystemRedirects(d);
},
callBrowserAdapter: function(a, b) {
...
var b = this.getClientRect(), c = this.getZoomRect(), d = this.fetchScrollPosition();
this._zoomStart = {
scale: a.scale,
zoom: this.zoom,
...
var c = a.centerX - b.offsetLeft || b.centerX, d = a.centerY - b.offsetTop || b.centerY, e = this.calcScale(a.scale, b.zoom), f = e.scale, g = this.calcScaledOffset(f, b.centerX, b.clientWidth, b.zoomWidth, b.zoomOffsetLeft);
g += f * b.scrollX, g += f * (b.centerX - c);
var h = this.calcScaledOffset(f, b.centerY, b.clientHeight, b.zoomHeight, b.zoomOffsetTop);
return h += f * b.scrollY, h += f * (b.centerY - d), {
zoom: e.zoom,
x: g,
y: h
};
},
calcScale: function(a, b) {
var c = Math.round(a * 100) / 100, d = b * c;
return d > this.getMaxZoom() && (c = this.getMaxZoom() / b), d < this.getMinZoom() && (c = this.getMinZoom() / b), {
scale: c,
zoom: d
};
},
calcScaledOffset: function(a, b, c, d, e) {
return c - d < 0 || (a - 1) * d / 2 > e ? d * a > c ? (a - 1) * b - e : (a - 1) * b + (c - d * a) / 2 : (a - 1) * (b - d / 2);
},
calcScaledCenter: function(a, b, c, d, e, f, g) {
return a -= b * c, d - e < 0 || (b - 1) * e / 2 > g ? e * b > d ? (a + g) / (b - 1) + (f + g) : (a - (d - e * b) / 2) / (b - 1) + (f + g) : a / (b - 1) + e / 2 + (f + g);
},
calcZoomCenter: function(a, b, c) {
var d = this.getClientRect(), e = this.getZoomRect(), f = this.fetchScrollPosition(), g = this.calcScale(a, this.zoom), h = g.scale, i = this.calcScaledCenter(b, h, f.l, d.width, e.width, d.left, e.left), j = this.calcScaledCenter(c, h, f.t, d.height, e.height, d.top, e.top);
return {
x: i,
y: j
};
...
return b && (a.l = b.getScrollLeft(), a.t = b.getScrollTop()), a;
},
...
srcChanged: function() {
this.src && this.bufferImage.src == this.src ? this.imageLoaded() : this.src && (this.bufferImage.src || this.$.image.setSrc("$base-themes-default-theme/images/blank.gif"), this.bufferImage.src = this.src);
},
...
if (a && b) {
var c = enyo.dom.calcNodeOffset(a, b), d = a.getBoundingClientRect();
return {
...
clickHandler: function(a, b) {
if (!this._clickMode) return this._clickMode = -1, this._clickJob = setTimeout(enyo.hitch(this, function() {
this._clickMode = 1, enyo.dispatch(b);
}), 300), !0;
var c = this._clickMode != 1;
return this._clickMode = 0, c;
},
dblclickHandler: function(a, b) {
if (this._clickJob && this._clickMode != -1) {
this._clickMode = 0, clearTimeout(this._clickJob), this._clickJob = null, this.smartZoom(b);
return;
}
return !0;
},
calcCenterForSmartZoom: function(a) {
if (this.toZoom == this.minZoom) return this.calcZoomCenter(1 / this.maxZoomRatio, 0, 0);
var b = this.getClientRect(), c = {
x: a.clientX,
y: a.clientY
}, d = this.calcZoomCenter(this.maxZoomRatio, 0, 0), e = this.calcZoomCenter(this.maxZoomRatio, this.maxZoom * this._imageWidth - b.width, this.maxZoom * this._imageHeight - b.height), f = c.x < d.x || d.x > e.x ? d.x : c.x > e.x ? e.x : c.x, g = c.y < d.y || d.y > e.y ? d.y : c.y > e.y ? e.y : c.y;
return {
x: f,
y: g
};
...
if (this.disableZoom) return;
this.smartZooming = !0, this.fromZoom = this.zoom, this.toZoom = Math.abs(this.zoom - this.minZoom) > .1 && !b ? this.minZoom : this.maxZoom;
...
dragstartHandler: function() {
return this.snapping || this.dragging ? (this._preventClick = !0, this.preventDragPropagation) : this.inherited(arguments);
},
dragfinishHandler: function(a, b) {
this._preventClick && (this._preventClick = !1, b.preventClick()), this.inherited(arguments);
},
flickHandler: function(a, b) {
return this.snapping ? this.preventDragPropagation : this.inherited(arguments);
},
...
return enyo.call(e, "setOuterScroller", [ this ]), e;
},
...
resizeHandler: function() {
this.resize(), this.broadcastToControls("resize");
},
resize: function() {
this.sizeControls("100%", "100%"), this.measureControlSize(), this._controlSize[this.scrollH ? "width" : "height"] = this._controlSize[this.scrollH ? "width" : "height"] - 2 * this.revealAmount, this.sizeControls(this._controlSize.width + "px", this._controlSize.height + "px", !0), this.snapping || this.setIndex(this.index);
},
...
calcPos: function(a) {
if (!this.getControls()[a]) return;
var b = 0, c = this._controlSize[this.scrollH ? "width" : "height"];
...
scrollStop: function() {
this.inherited(arguments);
if (!this._controlSize) return;
var a = this.scrollH ? this._controlSize.width : this._controlSize.height;
...
return c && a.setShowing(d ? !0 : !1), d;
},
adjustViews: function() {
var a = this.index > this.oldIndex, b = a ? this.$.right : this.$.left, c = a ? this.$.left : this.$.right;
a ? ++this.viewIndex : --this.viewIndex;
if (this.index != this.centerIndex && this.updateView(c, a ? this.viewIndex + 1 : this.viewIndex - 1)) {
...
if (this.panning || g && e + this.overscrollWidth >= h && e - this.overscrollWidth <= i) return b.preventClick = function() {
this._preventClick = !0;
}, d.dragfinishHandler(a, b), !0;
...
onKeyboardShown: "fadeHandler"
} ],
pack: "center",
align: "center",
className: "enyo-toolbar",
defaultKind: "ToolButton",
fadeHandler: function(a, b) {
this.fadeOnKeyboard && b.showing && this.fadeIn();
},
fadeIn: function() {
this.removeClass("enyo-toolbar-fade-in"), this.addClass("enyo-toolbar-snap-out"), enyo.job(this.id + "fade", enyo.bind(this, "_fadeIn"), 300);
},
_fadeIn: function() {
...
this.setHeld(!0), this.fire("onmousehold", b);
},
...
var c = this.getDx(b);
return b.preventClick(), this.handlingDrag = !1, this.resetPosition(), Math.abs(c) > this.triggerDistance && this.handleSwipe(), !0;
}
...
return this.setConfirmShowing(!1), this.doConfirm(this.index), !0;
},
cancelSwipe: function(a) {
return this.setConfirmShowing(!1), this.doCancel(this.index), !0;
},
getDx: function(a) {
...
showingChanged: function() {
if (this.showing && this.autoCloseSubItems) for (var a = 0, b = this.getControls(), c; c = b[a]; a++) enyo.call(c, "closeAll");
this.inherited(arguments);
},
...
_depth: 0,
create: function(a) {
this.inherited(arguments), this.value === undefined && (this.value = this.caption), this.caption = this.caption || this.content || this.value, this.needsItemChrome && this.validateItemChrome(), this.setCaptionControl(this.$.item), this.$.item.addClass(this.itemClassName), this.iconChanged(), this.captionChanged(), this.openChanged(), this.disabledChanged(), this.tapHighlightChanged();
},
addControl: function(a) {
...
owner: this
}), this.generated && this.$.item.render(), this.setCaptionControl(this.$.caption), this.captionChanged();
},
styleDepth: function() {
...
return this.$.item.addRemoveItemClass("enyo-single", c == 1), this.$.item.addRemoveItemClass("enyo-first", b == 0), this.$.item.addRemoveItemClass("enyo-last", b == c - 1), this.$.item.setCaption(e), this.doSetupItem(this.$.item, b, d), !0;
}
},
itemsChanged: function() {
...
openClassName: "enyo-modaldialog-open",
dismissWithClick: !1,
published: {
caption: "",
contentHeight: "",
...
return a.height += f, this.finishMeasureSize(), a;
},
componentsReady: function() {
...
tapHighlight: !1,
owner: this
}), this.makePopup(), this.contentPackChanged(), this.itemsChanged(), this.disabledChanged(), this.labelChanged(), this.hideArrowChanged();
},
disabledChanged: function() {
this.$.itemContainer.addRemoveClass("enyo-disabled", this.disabled);
},
contentPackChanged: function() {
this.$.content.pack = this.contentPack, this.$.content.flow();
},
...
showingChanged: function() {
this.inherited(arguments), enyo.appMenu.isOpen = this.showing;
},
open: function() {
this.setBoundsInfo("applyBounds"), this.inherited(arguments);
},
close: function(a, b) {
this.inherited(arguments);
}
...
itemClick: function() {
this.inherited(arguments);
var a = this.target.match(/^http[sS]?:\/\/([^\/:?]+)/), b = a && a.length >= 2 && this.stringEndsWith(a[1], "palm.com");
b ? this.$.launchHelp.call({
id: this.helpAppId,
params: {
target: this.target
}
}) : this.$.launchHelp.call({
target: this.target
});
},
...
clickHandler: function(a, b) {
return this.openPopup(b), this.doClick(b);
},
resizeHandler: function() {
this.inherited(arguments), this.popup.resized();
},
...
kind: "Popup",
allowHtml: !0,
className: "enyo-pickergroup-pickerpopup"
} ]);
},
addControl: function(a) {
...
a = this.is24HrMode ? a : a + (a == 12 ? -!c * 12 : c);
var d = this.value.getFullYear(), e = this.value.getMonth(), f = this.value.getDate(), g = this.value.getSeconds(), h = this.value.getMilliseconds();
this.setValue(new Date(d, e, f, a, b, g, h)), this.doChange(this.value);
}
});
;
...
setYMD:function(){
	this.bLoaded=true;
	this.value = this.value || new Date, this.setupMonth(), this.yearRangeChanged(), this.valueChanged();	
},
setNull:function(){
	this.value=null;
	this.bLoaded=false;
	this.$.month.setItems([{caption:"----",value:1}]);
	this.$.year.setItems([{caption:"------",value:1}]);
...
monthLength: function(a, b) {
return 32 - (new Date(a, b, 32)).getDate();
},
setupDay: function(a, b, c) {
var d = this.monthLength(a, b), e = [];
...
var b, c, d;
d = parseInt(this.$.year.getValue()), b = parseInt(this.$.month.getValue()), c = Math.min(parseInt(this.$.day.getValue()), this.monthLength(d, b));
var e = this.value.getHours(), f = this.value.getMinutes(), g = this.value.getSeconds(), h = this.value.getMilliseconds();
this.setValue(new Date(d, b, c, e, f, g, h)), this.doChange(this.value);
}
});
;
...
dragstartHandler: function(a, b) {
return this.handlingDrag = !0, this._width = this.calcWidth(), this.$.button.setDown(!0), !0;
},
dragHandler: function(a, b) {
if (this.handlingDrag) {
...
this.setAttribute("type", "application/x-palm-remote"), this.setAttribute("exe", this.executable), this.setAttribute("alphablend", this.alphaBlend ? "true" : "false"), this.setAttribute("killTransparency", this.killTransparency ? "true" : "false"), this.setAttribute("x-palm-cache-plugin", this.cachePlugin ? "true" : "false"), this.bgcolor && this.setAttribute("bgcolor", this.bgcolor), this.allowKeyboardFocus && this.setAttribute("tabIndex", 0);
...
rendered: function() {
this.inherited(arguments), this.pluginReady = !1, this.hasNode() && (this.passTouchEvents && (this.node.addEventListener("touchstart", this.nullTouchHandler), this.node.addEventListener("touchend", this.nullTouchHandler), this.node.addEventListener("touchmove", this.nullTouchHandler)), this.node.__PDL_PluginStatusChange__ = enyo.bind(this, this.pluginStatusChangedCallback), this.deferredCallbacks.forEach(function(a) {
this.node[a.name] = a.callback;
}, this));
},
destroy: function() {
this.passTouchEvents && this.node && (this.node.removeEventListener("touchstart", this.nullTouchHandler), this.node.removeEventListener("touchend", this.nullTouchHandler), this.node.removeEventListener("touchmove", this.nullTouchHandler)), this.inherited(arguments);
},
...
constructor: function() {
this.rows = [], this.inherited(arguments);
},
addChild: function(a) {
...
addControl: function(a) {
this.controlIsRow(a) && this.rows.push(a), this.inherited(arguments);
},
removeControl: function(a) {
this.controlIsRow(a) && enyo.remove(a, this.rows), this.inherited(arguments);
},
controlIsRow: function(a) {
return a instanceof enyo.Item;
},
getControls: function() {
var a = this.inherited(arguments), b = [];
for (var c = 0, d; d = a[c]; c++) d.isRowWrapper || b.push(d);
return b;
},
indexOfControl: function(a) {
return enyo.indexOf(a, this.getControls());
},
rowAtIndex: function(a) {
return this.rows[a];
},
flow: function() {
...
showRow: function(a) {
var b = this.rowAtIndex(a);
b && (b.setShowing(!0), this.$.client.flow());
},
hideRow: function(a) {
var b = this.rowAtIndex(a);
b && (b.setShowing(!1), this.$.client.flow());
}
}), enyo.kind({
name: "enyo.RowItem",
kind: enyo.Item,
...
removeChild: function(a) {
this.inherited(arguments), this.isRowWrapper && this.destroy();
},
...
return this.hasNode() ? (this._offset = undefined, this._offset !== undefined ? this._offset : this._offset = this.node.offsetLeft) : 0;
},
...
isDraggableEvent: function(a) {
return this.findSlidingHandler(a.dispatchTarget) || this.dragAnywhere;
},
findSlidingHandler: function(a) {
var b = a;
while (b && b.isDescendantOf(this)) {
if (b.slidingHandler === !1) return;
if (b.slidingHandler) return b;
b = b.parent;
}
},
canDrag: function(a) {
...
this.validateSlideBefore(), this.lastDragDx = a.dx, this.dragStart = this.slidePosition - b;
},
...
if (this.pendingDragMove || b == this.slidePosition) return;
...
var c;
a && !this.fixedWidth ? c = this.calcFitWidth() : this.$.client.domStyles.width && (c = null), c !== undefined && (c = c ? c + "px" : null, this.$.client.hasNode() && (this.$.client.domStyles.width = this.$.client.node.style.width = c, b || (this.doResize(c), this.broadcastToControls("resize"))));
},
calcFitWidth: function() {
var a = null;
if (this.hasNode() && this.$.client.hasNode()) {
var b = this.parent.getBounds().width, c = this.getLeftOffset(), d = Math.min(this.slidePosition || 0, 0);
a = Math.max(0, Math.min(b, b - c - d));
}
return a;
},
clickHandler: function(a, b) {
var c;
return this.findSlidingHandler(b.dispatchTarget) && (this.toggleSelected(), c = !0), this.doClick(b) || c;
},
...
this.dx0 = 0;
if (d) return this.stopAnimation(), this.dragSliding(d, b, 0), !0;
}
},
...
return this.dragStartSliding.overSliding = this.dragStartSliding.slidePosition + a >= 0, this.dragStartSliding;
},
...
resizeHandler: function() {
this.getBounds().height && (this.resize(!0), this.inherited(arguments));
},
resize: function(a) {
var b = this.multiViewMinWidth > 0 && window.innerWidth > this.multiViewMinWidth;
this.setMultiView(b), this.validateViews(a);
},
...
validateViews: function(a) {
this.validateViewPositions(), this.resetOverSliding(), a ? this.validateViewSizes(a) : enyo.job(this.id + ":resize", enyo.bind(this, "validateViewSizes", a), 10);
},
validateViewPositions: function() {
var a = this.view && this.view.getFirstSibling() || this.view;
a && a.validateSlide();
},
validateViewSizes: function(a) {
var b = this.view && this.view.getLastShowingSibling();
for (var c = 0, d; d = this.views[c]; c++) d.applySize(d == b, a);
},
...
return b = enyo.mixin(c, b), this.subscribe && (b.params.subscribe = !0, b.subscribe = !0), b;
}
}), enyo.kind({
...
call: function(a, b) {
return b = b || {}, b.dbKind = b.dbKind || this.dbKind || this.masterService.dbKind, this.inherited(arguments, [ a, b ]);
},
makeRequestProps: function(a) {
var b = this.inherited(arguments);
...
return a.params = enyo.mixin(b, a.params), this.request(a);
},
delKind: function(a) {
return a.params = {
id: a.dbKind
...
return b.query = enyo.mixin(c, b.query), a.params = b, this.request(a);
},
delByQuery: function(a) {
a.method = "del";
var b = a.params = a.params || {};
return b.query = enyo.mixin({
from: a.dbKind
}, b.query || {}), this.request(a);
},
...
}, this.log(this.response.errorText)), !this.response.returnValue;
}
...
return b.setAttribute("id", "webosconnect"), b.setAttribute("code", "com.palm.webos.connect.DeviceConnection"), b.setAttribute("archive", a), b.setAttribute("mayscript", "true"), b.style.visibility = "hidden", document.body.appendChild(b), enyo.WebosConnect.applet = b;
}
},
create: function() {
...
var e = b;
return e && window[e] && window[e]('{"returnValue": false, "errorText": "' + d + '"}\n'), null;
}
},
...
return d += " -a " + enyo.WebOsPalmServiceBridge.spoofId, d += " -i", d += " " + a, d += " " + c, d += "\n", this.execute(d);
},
execute: function(a) {
return this.data = "", this.connection = this.$.webosConnect.execute(a, this.gotDataFnName, this.disconnectFnName), this.connection;
},
gotData: function(a) {
var b = String(a);
this.data += b;
...
if (a == this.pageTop) return;
this.pageTop = a, this.updatePages(), this.doScroll();
},
effectScrollNonAccelerated: function() {
...
if (b >= this.top && b <= this.top + this.margin && b <= this.bottom) return;
var c = b - this.margin;
while (this.top < c) this.shift();
while (this.top > b) if (this.unshift() === !1) return this.firstPage = this.top, this.top <= a && this.bottom >= a;
},
adjustBottom: function(a) {
this.specBottom = a;
var b = a + this.overbuffer;
if (b >= this.bottom - this.margin && b <= this.bottom) return;
var c = b + this.margin;
while (this.bottom > c) this.pop();
while (this.bottom < b) if (this.push() === !1) return this.lastPage = this.bottom, this.bottom >= a;
},
shift: function() {
...
acquirePage: function(a) {
var b = this.pages[a];
b && (b.style.display = "", this.heights[a] || (this.heights[a] = b.offsetHeight), this.height += this.heights[a]);
},
discardPage: function(a) {
var b = this.pages[a];
...
rendered: function() {
this.inherited(arguments), this.$.list.enableNodeAccess();
},
prepareRow: function(a) {
...
refresh: function() {
this.$.list.saveCurrentState(), this.$.scroller.refreshPages(), this.$.list.enableNodeAccess();
},
reset: function() {
...
resizeHandler: function() {
this.hasNode() ? (this.$.scroller.measure(), this.refresh(), this.$.scroller.start()) : this.log("no node");
},
...
punt: function() {
var a = this.$.buffer;
a.flush(), a.top = a.specTop = 0, a.bottom = a.specBottom = -1, this.inherited(arguments);
}
});
;
// palm/list/dbUtil.js
...
return d && d[2] && (b.orderBy = d[2].slice(8)), b;
};
;
...
this.handles = [], b <= this.max ? this.handles[b] = c : b = 0;
},
query: function(a) {
var b = {
limit: this.size,
...
return a !== undefined && a !== null && (b.page = a), this.doQuery(b);
},
...
data: a.results,
request: b
}, this.min = Math.min(this.min, c), this.max = Math.max(this.max, c), this.setHandle(c, a.handle), this.setHandle(c + 1, a.next), this.doReceive(c);
},
...
var d = a - b * this.size;
return a < 0 && (d -= this.size - c.data.length), c.data[d] || null;
}
});
;
// palm/list/DbList.js
...
if ((c < d.specTop || c > d.specBottom) && this.needs === null) return;
...
setupRow: function(a, b) {
var c = this.fetch(b);
if (c) return this.doSetupRow(c, b), !0;
},
reset: function() {
...
punt: function() {
this.$.dbPages.reset(0), this.$.dbPages.handles = [], this.inherited(arguments);
}
});
;
...
var c = this.fetch(b);
return c ? (this.doSetupRow(c, b), !0) : c;
},
rendered: function() {
...
return setTimeout(enyo.bind(this, function() {
...
Tellurium.identifier = "palm://com.palm.telluriumservice/", Tellurium.nubVersion = "2.2.2", Tellurium.config = {
enableUserEvents: !1
...
Tellurium.noAppName = "noname.enyoapps", Tellurium.subscribeToCommands = function() {
...
var a = Tellurium.enyo.fetchAppInfo();
a || (a = {});
if (!a.id || a.id == "") {
a.id = Tellurium.enyo.fetchAppId();
if (!a.id || a.id == "") a.id = Tellurium.noAppName;
}
return a;
}, Tellurium.notifyEvent = function(a) {
if (!Tellurium.serviceAvailable) return;
Tellurium.stageId && (!Tellurium.inVerifyDialog || a.event === "verify") ? (a.stageId = Tellurium.stageId, a.appId = Tellurium.appId, Tellurium.notifyRequest = Tellurium.notifyRequest || new Tellurium.enyo.PalmService({
service: Tellurium.identifier,
method: "notifyEvent"
}), Tellurium.notifyRequest.call(a)) : Tellurium.delayedEvents.push(a);
...
if (!Tellurium.appId || Tellurium.appId == "") Tellurium.appId = Tellurium.noAppName;
...
var c = [];
for (var d in a) {
if (typeof a[d] == "function" && !b) continue;
c.push(d + " = " + a[d] + "\n");
}
return c.join("");
};
...
if (!b) throw {
message: Tellurium.invalidLocatorMessage("mouseTap", a)
};
var c = {
detail: 1,
ctrlKey: !1,
...
Tellurium.mouseEvent(b, "mousedown", c), Tellurium.mouseEvent(b, "mouseup", c), Tellurium.mouseEvent(b, "click", c);
}, Tellurium.mouseEvent = function(a, b, c) {
var d = Tellurium.getElement(a);
if (!d) throw {
message: Tellurium.invalidLocatorMessage("mouseEvent", a)
};
var e = Tellurium.getMetrics(d), f = document.createEvent("MouseEvents");
f.initMouseEvent(b, !0, !0, window, c.detail, e.left, e.top, e.left, e.top, c.ctrlKey, c.altKey, c.shiftKey, c.metaKey, c.button, null), d.dispatchEvent(f);
}, Tellurium.fireEvent = function(a, b, c) {
var d = Tellurium.getElement(a);
if (!d) throw {
message: Tellurium.invalidLocatorMessage("fireEvent", a)
};
var e = document.createEvent("HTMLEvents");
e.initEvent(b, !0, !0), d.dispatchEvent(e);
}, Tellurium.keyEvent = function(a, b, c, d, e, f, g, h) {
var i = Tellurium.getElement(a);
if (!i) throw {
message: Tellurium.invalidLocatorMessage("keyEvent", a)
};
...
if (!c) throw {
message: Tellurium.invalidLocatorMessage("textEvent", a)
};
var d = document.createEvent("TextEvent");
d.initTextEvent("textInput", !0, !0, null, b), c.dispatchEvent(d);
}, Tellurium.simulatedTap = function(a) {
if (typeof a == "string" && a === "window") return Tellurium.simulatedTapXY(Math.round(window.innerWidth / 2), Math.round(window.innerHeight / 2));
var b = Tellurium.getElement(a);
if (!b) throw {
message: Tellurium.invalidLocatorMessage("simulatedTap", a)
};
var c = Tellurium.getMetrics(b);
return Tellurium.simulatedTapXY(Math.round(c.left + c.width / 2), Math.round(c.top + c.height / 2));
}, Tellurium.simulatedTapXY = function(a, b) {
return window.PalmSystem.simulateMouseClick(a, b, !0), window.PalmSystem.simulateMouseClick(a, b, !1), !0;
}, Tellurium.mojoTap = function(a) {
throw {
message: "mojoTap in Tellurium.Nub is an invalid method for enyo apps."
};
};
;
...
var b = {};
return a.target & a.target.getStyle && (b.lineFeed = a.target.getStyle("-webkit-user-modify") == "read-write"), this.mixinPayloadDetails(b, a, this.keyDetails);
},
mouseDetails: {
type: !0,
detail: !0,
...
return a.type = d, Tellurium.notifyEvent(a), c.apply(this, arguments);
};
},
...
return e && (b = e[1].toLowerCase(), c = e[2]), b = b.substr(0, 1).toUpperCase() + b.substr(1), Tellurium["getElementBy" + b].call(this, c, d);
...
var b = Tellurium.getElement(a);
if (!b) throw {
message: Tellurium.invalidLocatorMessage("getElementIndex", a)
};
var c = b.parentNode.childNodes, d = 0, e = 0;
for (var f = 0; f < c.length; f++) {
var g = c[f];
g.nodeName === b.nodeName && d++, g === b && (e = d);
}
return d > 1 ? e : 0;
...
return console.error("XPATH IS NOT UNIQUE: /" + c), "/" + c;
...
if (a) {
var c = Tellurium.getElement(a), b = b || "yellow";
Tellurium.highlight = {
locator: a,
...
}, Tellurium.getLocatorInfo = function(a) {
return typeof a == "string" ? "(locator: " + a + ")" : a.id ? "(locator id: " + a.id + ")" : "(locator type: " + typeof a + ")";
};
;
...
var b = document.evaluate(a, document, null, XPathResult.ANY_TYPE, null), c = b.iterateNext();
if (c == null) return console.log("Invalid xpath"), !1;
var d = {
detail: 1,
ctrlKey: !1,
altKey: !1,
...
metaKey: !1,
button: 0
}, e = document.createEvent("MouseEvents"), f = c.id, g = Tellurium.getMetrics("#" + f);
return e.initMouseEvent("click", !0, !0, window, d.detail, g.left, g.top, g.left, g.top, d.ctrlKey, d.altKey, d.shiftKey, d.metaKey, d.button, null), c.dispatchEvent(e), !0;
...
return c.innerHTML = b, !0;
}, Tellurium.setElementValue = function(selector, propertyname, value) {
return eval("document.querySelector(selector)." + propertyname + "='" + value + "'"), !0;
...
return Tellurium.enyo.mixin(b, c), d;
}, Tellurium.viewportOffset = function(locatorOrElement) {
var targetEl = Tellurium.getElement(locatorOrElement);
if (!targetEl) throw {
message: Tellurium.invalidLocatorMessage("viewportOffset", locatorOrElement)
};
...
try {
scrollTop = eval("Tellurium.enyo.windows.getActiveWindow().enyo.$." + currentEl.id + ".getScrollTop()"), scrollLeft = eval("Tellurium.enyo.windows.getActiveWindow().enyo.$." + currentEl.id + ".getScrollLeft()"), top -= scrollTop, left -= scrollLeft;
...
return result === undefined ? "[No Result]" : result === null ? "[Null Result]" : result;
}, Tellurium.focus = function(a) {
var b = Tellurium.getElement(a);
if (!b) throw {
message: Tellurium.invalidLocatorMessage("focus", a)
};
b.focus();
}, Tellurium.blur = function(a) {
var b = Tellurium.getElement(a);
if (!b) throw {
message: Tellurium.invalidLocatorMessage("blur", a)
};
b.blur();
}, Tellurium.getProperty = function(a, b) {
var c = Tellurium.getElement(a);
if (!c) throw {
message: Tellurium.invalidLocatorMessage("getProperty", a)
};
return c[b];
}, Tellurium.setProperty = function(a, b, c) {
var d = Tellurium.getElement(a);
if (!d) throw {
message: Tellurium.invalidLocatorMessage("setProperty", a)
};
d[b] = c;
}, Tellurium.getStyleProperty = function(a, b) {
var c = Tellurium.getElement(a);
if (!c) throw {
message: Tellurium.invalidLocatorMessage("getStyleProperty", a)
};
...
var d = Tellurium.getElement(a);
if (!d) throw {
message: Tellurium.invalidLocatorMessage("setStyleProperty", a)
};
d.style[b] = c;
...
var b = Tellurium.getElement(a);
if (!b) return !1;
var c = Tellurium.findScrollerAncestor(b);
if (!c) return !1;
try {
Tellurium.scrollToElement(c, b);
} catch (d) {
return !1;
}
return !0;
}, Tellurium.findScrollerAncestor = function(a) {
var b = Tellurium.getElement(a);
if (!b) return null;
if (b.style.display === "none") return null;
if (b.offsetTop == undefined || b.offsetTop == null) return null;
...
if (d.style.display === "none") return null;
try {
Tellurium.getEnyoScroller(d, "findScrollerAncestor");
} catch (g) {
continue;
}
c = !0;
...
var b = Tellurium.getElement(a);
if (!b) throw {
message: Tellurium.invalidLocatorMessage("getWidth", a)
};
return Tellurium.getDimensions(b).width;
}, Tellurium.getHeight = function(a) {
var b = Tellurium.getElement(a);
if (!b) throw {
message: Tellurium.invalidLocatorMessage("getHeight", a)
};
return Tellurium.getDimensions(b).height;
}, Tellurium.getViewportOffsetTop = function(a) {
var b = Tellurium.getElement(a);
if (!b) throw {
message: Tellurium.invalidLocatorMessage("getViewportOffsetTop", a)
};
return Tellurium.viewportOffset(b).top;
}, Tellurium.getViewportOffsetLeft = function(a) {
var b = Tellurium.getElement(a);
if (!b) throw {
message: Tellurium.invalidLocatorMessage("getViewportOffsetLeft", a)
};
return Tellurium.viewportOffset(b).left;
}, Tellurium.getMetrics = function(a) {
var b = Tellurium.getElement(a);
if (!b) throw {
message: Tellurium.invalidLocatorMessage("getMetrics", a)
};
var c = Tellurium.viewportOffset(b), d = Tellurium.getDimensions(b), e = {
width: d.width,
height: d.height,
left: c.left,
top: c.top
...
return !1;
}, Tellurium.invalidLocatorMessage = function(a, b) {
return a + "() in TelluriumNub - invalid locator or element " + Tellurium.getLocatorInfo(b);
};
;
// palm/tellurium/cards.js

Tellurium.getViewNameByPaneId = function(paneId) {
if (!Tellurium.enyo.windows.getActiveWindow()) throw {
message: "getViewNameByPaneId() in TelluriumNub - app stage is not the active window."
};
...
return typeof Tellurium.enyo.windows.getActiveWindow() == "object" ? !0 : !1;
...
throw {
message: "isMenuVisible in TelluriumNub is an invalid method for enyo apps."
};
}, Tellurium.toggleMenuVisible = function(a) {
throw {
message: "toggleMenuVisible in TelluriumNub is an invalid method for enyo apps."
};
}, Tellurium.getMenuCommands = function(a) {
throw {
message: "getMenuCommands in TelluriumNub is an invalid method for enyo apps."
};
}, Tellurium.sendMenuCommand = function(a) {
throw {
message: "sendMenuCommand in TelluriumNub is an invalid method for enyo apps."
};
}, Tellurium.getIndexFromList = function(a, b) {
throw {
message: "getIndexFromList in TelluriumNub is an invalid method for enyo apps."
};
}, Tellurium.getListItems = function(a, b, c) {
throw {
message: "getListItems in TelluriumNub is an invalid method for enyo apps."
};
}, Tellurium.getListLength = function(a) {
throw {
message: "getListLength in TelluriumNub is an invalid method for enyo apps."
};
...
throw {
message: "revealListItem in TelluriumNub is an invalid method for enyo apps."
};
}, Tellurium.getListItemJsonObject = function(a) {
throw {
message: "getListItemJsonObject in TelluriumNub is an invalid method for enyo apps."
};
}, Tellurium.getListItemMetrics = function(a, b) {
throw {
message: "getListItemMetrics in TelluriumNub is an invalid method for enyo apps."
};
}, Tellurium.textFieldGetValue = function(a) {
throw {
message: "textFieldGetValue in TelluriumNub is an invalid method for enyo apps."
};
}, Tellurium.textFieldSetValue = function(a, b) {
throw {
message: "textFieldSetValue in TelluriumNub is an invalid method for enyo apps."
};
}, Tellurium.textFieldGetCursorPosition = function(a) {
throw {
message: "textFieldGetCursorPosition in TelluriumNub is an invalid method for enyo apps."
};
}, Tellurium.textFieldSetCursorPosition = function(a, b, c) {
throw {
message: "textFieldSetCursorPosition in TelluriumNub is an invalid method for enyo apps."
};
}, Tellurium.isScrolling = function(a) {
var b = Tellurium.getEnyoScroller(a, "isScrolling");
if (b.isScrolling) return b.isScrolling() ? !0 : !1;
if (b.$.scroll.isScrolling) return b.$.scroll.isScrolling() ? !0 : !1;
throw {
message: "isScrolling() in TelluriumNub - locatorOrElement does not appear to be an enyo scroller " + Tellurium.getLocatorInfo(a)
};
}, Tellurium.getScrollerPositionMetrics = function(a) {
var b = Tellurium.getEnyoScroller(a, "getScrollerPositionMetrics");
if (b.getScrollLeft && b.getScrollTop) {
var c = {
left: b.getScrollLeft(),
top: b.getScrollTop()
};
return c;
}
if (b.$.scroll.getScrollLeft && b.$.scroll.getScrollTop) {
var c = {
left: b.$.scroll.getScrollLeft(),
top: b.$.scroll.getScrollTop()
};
return c;
}
throw {
message: "getScrollerPositionMetrics() in TelluriumNub - no getScrollLeft/getScrollTop methods for this scroller type " + Tellurium.getLocatorInfo(a)
};
}, Tellurium.scrollerOffset = function(a, b) {
var c = Tellurium.getElement(b);
if (!c) throw {
message: Tellurium.invalidLocatorMessage("scrollerOffset", b)
};
var d = Tellurium.getEnyoScroller(a, "scrollerOffset").node, e = c, f = 0, g = 0;
while (e && e !== d) f += e.offsetTop, g += e.offsetLeft, e !== c && (f += e.clientTop, g += e.clientLeft), e = e.offsetParent;
return Tellurium.createOffset(g, f);
}, Tellurium.scrollToBottom = function(a) {
var b = Tellurium.getEnyoScroller(a, "scrollToBottom");
if (b.scrollToBottom) b.scrollToBottom(); else if (b.$.scroll.scrollToBottom) b.$.scroll.scrollToBottom(); else throw {
message: "scrollToBottom() in TelluriumNub - no scrollToBottom method for this scroller type " + Tellurium.getLocatorInfo(a)
};
}, Tellurium.scrollToTop = function(a) {
var b = Tellurium.getEnyoScroller(a, "scrollToTop");
if (b.scrollTo) b.scrollTo(0, 0); else if (b.$.scroll.scrollTo) b.$.scroll.scrollTo(0, 0); else throw {
message: "scrollToTop() in TelluriumNub - no scrollTo method for this scroller type " + Tellurium.getLocatorInfo(a)
};
}, Tellurium.scrollToElement = function(a, b) {
var c = Tellurium.getElement(b);
if (!c) throw {
message: Tellurium.invalidLocatorMessage("scrollToElement", b)
};
var d = Tellurium.getEnyoScroller(a, "scrollToElement");
if (d.scrollTo) d.scrollTo(Tellurium.scrollerOffset(d.node, c).top, 0); else if (d.$.scroll.scrollTo) d.$.scroll.scrollTo(Tellurium.scrollerOffset(d.node, c).top, 0); else throw {
message: "scrollToElement() in TelluriumNub - no scrollTo method for this scroller type " + Tellurium.getLocatorInfo(b)
};
}, Tellurium.scrollToViewable = function(a, b, c) {
var d = Tellurium.getEnyoScroller(a, "scrollToViewable");
if (d.scrollTo) d.scrollTo(c, b); else if (d.$.scroll.scrollTo) d.$.scroll.scrollTo(c, b); else throw {
message: "scrollToViewable() in TelluriumNub - no scrollTo method for this scroller type " + Tellurium.getLocatorInfo(a)
};
}, Tellurium.getEnyoScroller = function(locatorOrElement, callerName) {
var msgPrefix = callerName + "() in TelluriumNub - ", scrollerElement = Tellurium.getElement(locatorOrElement);
if (!scrollerElement) throw {
message: Tellurium.invalidLocatorMessage(callerName, locatorOrElement)
};
if (!scrollerElement.id) throw {
message: msgPrefix + "locatorOrElement found, but it has no 'id' property " + Tellurium.getLocatorInfo(locatorOrElement)
};
if (!Tellurium.enyo.windows.getActiveWindow()) throw {
message: msgPrefix + "this app stage is not the active window."
};
var enyoScroller = eval("Tellurium.enyo.windows.getActiveWindow().enyo.$." + scrollerElement.id);
if (enyoScroller && (enyoScroller.isScrolling || enyoScroller.$.scroll.isScrolling)) return enyoScroller;
throw {
message: msgPrefix + "locatorOrElement does not appear to be an enyo scroller " + Tellurium.getLocatorInfo(locatorOrElement)
};
};
;
...
enyo.requiresWindow(function() {
if (window.PalmSystem) {
var a = window.enyo.xhr.request({
url: Tellurium.nubPath + "tellurium_config.json",
sync: !0
}), b = a && a.responseText;
