enyo.kind(
  {
          ...
          components :
            [
              ...
              },
              {
                ...
                classes : "transitioner2",
                layoutKind : "VFlexLayout",
                style : "overflow: hidden; posiposition:absolute",
                width : "95%",
                height : "95%",
                scrim : true,
              } ]
    ...
    addRowHeader : function() {
      ...
      this.addCustomCell("alatwo", "<strong>ZONA SUR</strong>", "200px", "30px", "customBYcellZone");
      this.splitRow();
      this.addCustomCell("alaone", "<strong>CHIHUAHUA</strong>", "765px", "30px", "customBYcellZone");
      this.addQuitButton();
      this.addRow();
    },
    ...
    setDesc : function(sBY) {
      ...
      this.$.spacerone.setContent("<strong>" + objRec.rancher_name + "</strong> " + ": " + Math.round(objRec.hc_aprox) + " " + objRec.cattype_name
          + " de " + objRec.location_name + ". " + objRec.weights[0].weight + " Kg., " + Math.round((objRec.weights[0].weight * 2.2046) * 100) / 100
          + " Lb. Promedio: " + Math.round((objRec.weights[0].weight / objRec.hc_aprox) * 100) / 100 + "Kg.,"
          + Math.round((objRec.weights[0].weight / objRec.hc_aprox * 2.2046) * 100) / 100 + "Lb. </br> Corrales ("
          + iBy + ") - " + sBy);
    ...
    actionSelected : function(inSender, inSelected) {
      ...
      case 1:
        ...
        this.$.popMan.createComponent(
          {
            kind : "receptions.create",
            onAddReception : "updateBY",
            onCancel : "closePopUp",
            name : 'dynocon',
            flex : 1
          },
