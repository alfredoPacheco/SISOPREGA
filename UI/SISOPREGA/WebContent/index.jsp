...
<head>
	...
	<script src="../SISOPREGA_WEB_LIB/scripts/webServicesConsuming/config.js"></script>
	<script src="../SISOPREGA_WEB_LIB/scripts/webServicesConsuming/consumingGateway.js"></script>
	<script src="../SISOPREGA_WEB_LIB/scripts/maskedInput/jquery.maskedinput.js"></script>
