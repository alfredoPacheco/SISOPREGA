enyo.kind({
	...
	components: [	
		{kind: enyo.Scroller,
	     ...
	     flex: 1,
		 components: [
			  {kind: enyo.Popup, name:"addRancherDialog", flyInFrom: "bottom", width:"100%", height:"100%",
				components: [
				  {kind: "catalogs.ranchers.person.create",flex:1,lazy:false},				
					  ...
					  {kind: "Item",
						components: [
							...
							{layoutKind: enyo.HFlexLayout,components:[
								...
								{kind: "IconButton", caption: "", icon: "images/command-menu/menu-icon-new.png",
								 onclick:"addNewRancher"}
							]}							
					   ]},
	...
	addNewRancher:function(){
		this.$.addRancherDialog.open();
	}
});