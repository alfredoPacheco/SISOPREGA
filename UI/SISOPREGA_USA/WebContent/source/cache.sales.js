enyo.kind({
	...
	readData:function(){
		var arrData=[{sale_id:1,buyer:"Hascon",seller:"",cattleName:"Novillos",heads:127,
					  weight:45590,aveweight:359.0,saledate:"01/01"},
					 {sale_id:2,buyer:"Welton",seller:"",cattleName:"Novillos",heads:178,
					  weight:95130,aveweight:534.4,saledate:"01/01"},
					 {sale_id:3,buyer:"Friona",seller:"",cattleName:"Novillos",heads:219,
					  weight:97220,aveweight:443.9,saledate:"01/01"},			
					 {sale_id:4,buyer:"Alvaro Bustillos",cattleName:"Novillos",heads:13,
