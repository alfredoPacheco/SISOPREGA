enyo.kind(
  {
    ...
    validateAdd : function() { // function to override if necessary
      ...
      if (this.$.cattleQuality.getIndex() == -1 || this.$.pen.getIndex() == -1 || this.$.cabezas.getValue() == "" || this.$.peso.getValue() == "") {
    ...
    onDeleteItem : function() {
      if (this.arrDetail.length == 0) this.$.cattleType.setDisabled(false);
    },
