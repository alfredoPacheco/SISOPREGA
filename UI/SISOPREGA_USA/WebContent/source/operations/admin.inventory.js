...
//		    }
		    var cattle_name = crudCattle.getCattleTypeById(objData[inIndex].cattypeId);
		    if (cattle_name) {
		    ...
		    var quality_name= crudCattleQuality.getByID(objData[inIndex].qualityId);
		    if (quality_name) {
