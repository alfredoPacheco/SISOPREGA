enyo.kind(
  {
    ...
    isPenActiveInInventory : function(sPen) {
      for ( var i = 0; i < this.arrObj.length; i++) {
        if (("" + this.arrObj[i].pen.locationId + this.arrObj[i].pen.barnyardCode) == sPen) { return true; }
      }
      return false;
    },
    ...
    getByPen : function(sPen) {
      for ( var i = 0; i < this.arrObj.length; i++) {
        if (("" + this.arrObj[i].pen.locationId + this.arrObj[i].pen.barnyardCode) == sPen) { return this.arrObj[i]; }
      }
      return null;
    },
