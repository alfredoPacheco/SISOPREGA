...
enyo.kind(
  {
    ...
    // consumingGateway.ReadAsync("Rancher", {}, callBackObject,
    // callBackMethod);
    // },
    ...
    // // No data found
    // cacheMan.setMessage("", "[Exception ID: " + result.exceptionId + "]
    // Descripción: " + result.exceptionDescription);
    // }
    // }
    //
    // // Retrieve Enterprise Ranchers:
    // var cgReadAllEnterpriseRanchers =
    // consumingGateway.Read("EnterpriseRancher", {});
    ...
    // });
    // } else { // Error
    // if (cgReadAllEnterpriseRanchers.exceptionId != "VAL02" &&
    // cgReadAllEnterpriseRanchers.exceptionId == "DB02") {
    // // No data found
    // cacheMan.setMessage("", "[Exception ID: " +
    // cgReadAllEnterpriseRanchers.exceptionId + "] Descripcion: "
    ...
    get : function() {
      ...
      // // data found
      // cacheMan.setMessage("", "[Exception ID: " +
      // cgReadAllRanchers.exceptionId + "] Descripción: "
    ...
    del : function(delObj, cbObj, cbMethod) {
      ...
      // var cgDeleteEnterpriseRancher =
      // consumingGateway.Delete("EnterpriseRancher", objToSend);
      ...
      // } else { // Error
      // cacheMan.setMessage("", "[Exception ID: " +
      // cgDeleteEnterpriseRancher.exceptionId + "] Descripcion: "
      ...
      var objNew =
        {
          ...
          city : objSeller.city_id,
          addressState : objSeller.state_id,
    ...
    Create : function(obj, cbObj, cbMethod) {
      ...
      alert('Created with Id: ' + cgCreateSeller.generatedId);
      // var cgCreateEnterpriseRancher =
      // consumingGateway.Create("EnterpriseRancher", objToSend);
      ...
      // } else { // Error
      // cacheMan.setMessage("", "[Exception ID: " +
      // cgCreateEnterpriseRancher.exceptionId + "] Descripcion: "
    ...
    update : function(objOld, objNew, cbObj, cbMethod) {
      ...
      // var cgUpdateEnterpriseRancher =
      // consumingGateway.Update("EnterpriseRancher", objToSend);
      ...
      // } else { // Error
      // cacheMan.setMessage("", "[Exception ID: " +
      // cgUpdateEnterpriseRancher.exceptionId + "] Descripcion: "
