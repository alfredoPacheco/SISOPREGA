...
public class ClickatellProvider implements SmsProvider {
  ...
  public void sendSMS(final Sms sms) throws SendSmsException {
    ...
    final URL url;
    try {
      sRequest = String.format(REQUEST, API_URL, this.userID, this.passWord, this.apiID, sms.getFrom(), sms.getTo(),
  ...
  @Override
  public void setConfiguration(File xmlFile) throws InitSmsProviderException {
    ...
    try {
      ...
      this.doLogin(getValue("userid", element), getValue("password", element));
