...
public class ListaInspeccionHistorica extends BaseReportServlet {
  ...
  @EJB(lookup="java:global/ComProxy/PdfListaInspeccionHistorica")
  private Reporteable reporteListaInspeccionHistorica;
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    reporteListaInspeccionHistorica.setReportName("ListaInspeccionHistorica");
    reporteListaInspeccionHistorica.setParameters(params);
    //response.setHeader("Content-disposition","attachment; filename=GanadoRecibido.pdf");
    byte[] reportBytes = reporteListaInspeccionHistorica.getBytes();
