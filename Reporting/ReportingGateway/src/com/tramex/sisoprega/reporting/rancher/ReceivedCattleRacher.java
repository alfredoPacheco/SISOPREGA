...
@WebServlet("/ReceivedCattleRacher")
public class ReceivedCattleRacher extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  try {
	      ...
	      JasperReport reporte = (JasperReport) JRLoader.loadObject(getServletContext().getRealPath("WEB-INF/Reports/Ranchers/GanadoRecibidoRanchero.jasper"));
