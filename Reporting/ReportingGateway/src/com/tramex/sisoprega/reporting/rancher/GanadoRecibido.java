 ...
 * http://host/ReportingGateway/GanadoRecibido?fromDate=[MM/dd/yyyy]&toDate=[MM/dd/yyyy]
 * 
...
public class GanadoRecibido extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  try {
        ...
        JasperReport reporte = (JasperReport) JRLoader.loadObject(getServletContext().getRealPath("WEB-INF/Reports/Tramex/GanadoRecibido.jasper"));
